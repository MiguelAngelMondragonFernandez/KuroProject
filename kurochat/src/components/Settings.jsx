...
function Settings({ setState, userData, getUser }) {
  ...
  const { config, translations, changeLanguage, updateConfig } =
  ...
  return (
    <>
      <div
        className="flex flex-column h-screen border-[var(--text-color)] border-right-1"
      ...
      >
        ...
        <div className="flex w-full  border-[var(--text-color)] border-bottom-1 ">
          <div className="flex flex-column">
            <div
              id="Profile"
              className={`${isEditing ? "hidden" : ""} pb-3 pl-4 `}
            >
        ...
        <div className="flex flex-column pl-4 pr-4 pb-3 border-bottom-1 border-[var(--text-color)]">
          <div className={`${isChangePassword ? "hidden" : ""} `}>
