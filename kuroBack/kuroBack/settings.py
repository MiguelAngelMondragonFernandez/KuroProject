"""
Django settings for kuroBack project.
...
SECRET_KEY = 'django-insecure-vuf1=c#(+0#f&8m95!yki)=enk)m1-bxtz89x8ia@3^!_x30+9'
...
WSGI_APPLICATION = 'kuroBack.wsgi.application'
